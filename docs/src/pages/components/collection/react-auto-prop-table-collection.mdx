...
<ExpanderItem title="CollectionBaseProps" value="CollectionBaseProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
...
<ExpanderItem title="CollectionWrapperProps" value="CollectionWrapperProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
...
<ExpanderItem title="GridContainerStyleProps" value="GridContainerStyleProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
