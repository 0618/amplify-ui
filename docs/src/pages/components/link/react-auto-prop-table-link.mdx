...
<ExpanderItem title="AnchorHTMLAttributes" value="AnchorHTMLAttributes">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
...
| onKeyPress | KeyboardEventHandler&#60;HTMLAnchorElement&#62; | - | @deprecated |
| onKeyPressCapture | KeyboardEventHandler&#60;HTMLAnchorElement&#62; | - | @deprecated |
...
<ExpanderItem title="LinkOptions" value="LinkOptions">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
