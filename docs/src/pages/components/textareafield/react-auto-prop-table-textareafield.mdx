...
| onKeyPress | KeyboardEventHandler&#60;HTMLTextAreaElement&#62; | - | @deprecated |
| onKeyPressCapture | KeyboardEventHandler&#60;HTMLTextAreaElement&#62; | - | @deprecated |
...
<ExpanderItem title="TextAreaStyleProps" value="TextAreaStyleProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
...
<ExpanderItem title="TextareaHTMLAttributes" value="TextareaHTMLAttributes">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
