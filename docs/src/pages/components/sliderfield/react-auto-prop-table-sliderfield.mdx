...
| aria-current | boolean &#124; "time" &#124; "true" &#124; "false" &#124; "step" &#124; "page" &#124; "location" &#124; "date" | - | Indicates the element that represents the current item within a container or set of related elements. |
...
| onKeyPress | KeyboardEventHandler&#60;HTMLDivElement&#62; | - | @deprecated |
| onKeyPressCapture | KeyboardEventHandler&#60;HTMLDivElement&#62; | - | @deprecated |
...
<ExpanderItem title="InputProps" value="InputProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
...
<ExpanderItem title="SliderProps" value="SliderProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
