...
| onKeyPress | KeyboardEventHandler&#60;HTMLHRElement&#62; | - | @deprecated |
| onKeyPressCapture | KeyboardEventHandler&#60;HTMLHRElement&#62; | - | @deprecated |
...
<ExpanderItem title="DividerOptions" value="DividerOptions">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
