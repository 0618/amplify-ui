...
<ExpanderItem title="BasePaginationProps" value="BasePaginationProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
...
| onKeyPress | KeyboardEventHandler&#60;HTMLElement&#62; | - | @deprecated |
| onKeyPressCapture | KeyboardEventHandler&#60;HTMLElement&#62; | - | @deprecated |
