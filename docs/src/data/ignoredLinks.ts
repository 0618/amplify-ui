 ...
 * Links added to this list because they return unexpected status code.
...
export const IGNORED_LINKS = [
  ...
  'https://github.com/aws-amplify/amplify-ui/issues/new/choose', // 302. Can't reproduce the status code. Can't find the redirected link.
];
