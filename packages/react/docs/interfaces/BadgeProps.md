...
[badge.ts:15](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/badge.ts#L15)
...
• `Optional` **variation**: [`BadgeVariations`](../modules.md#badgevariations)

The variation property will affect the background color of the badge.

#### Defined in

[badge.ts:11](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/badge.ts#L11)
