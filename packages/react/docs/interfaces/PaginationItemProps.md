...
[AriaProps](AriaProps.md).[ariaLabel](AriaProps.md#arialabel)
...
[AriaProps](AriaProps.md).[ariaValuetext](AriaProps.md#ariavaluetext)
...
[pagination.ts:64](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/pagination.ts#L64)
...
[BaseComponentProps](BaseComponentProps.md).[id](BaseComponentProps.md#id)
...
[pagination.ts:69](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/pagination.ts#L69)
...
[BaseStyleProps](BaseStyleProps.md).[marginLeft](BaseStyleProps.md#marginleft)
...
[pagination.ts:59](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/pagination.ts#L59)
...
[AriaProps](AriaProps.md).[role](AriaProps.md#role)
...
[BaseComponentProps](BaseComponentProps.md).[testId](BaseComponentProps.md#testid)
...
• **type**: [`PaginationItemType`](../modules.md#paginationitemtype)

Available item type are 'page', 'next', 'previous' and 'ellipsis'.

#### Defined in

[pagination.ts:54](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/pagination.ts#L54)
...
[BaseStyleProps](BaseStyleProps.md).[whiteSpace](BaseStyleProps.md#whitespace)
...
▸ `Optional` **onClick**(`newPageIndex?`, `prevPageIndex?`): `void`
...
[pagination.ts:74](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/pagination.ts#L74)
