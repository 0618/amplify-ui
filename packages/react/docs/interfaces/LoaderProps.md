...
[loader.ts:26](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/loader.ts#L26)

---

### filledColor

• `Optional` **filledColor**: `Color`

This will set the filled color of Loader.

#### Defined in

[loader.ts:22](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/loader.ts#L22)
...
[loader.ts:14](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/loader.ts#L14)
...
• `Optional` **variation**: `"linear"`

This will set the variation of Loader. Available options are linear and none(circular).

#### Defined in

[loader.ts:18](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/loader.ts#L18)
