...
- [`AriaProps`](AriaProps.md)

- [`BaseStyleProps`](BaseStyleProps.md)

- [`FlexProps`](FlexProps.md)

- `Pick`<[`ButtonProps`](ButtonProps.md), `"size"` \| `"variation"`\>
...
[buttonGroup.ts:13](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/buttonGroup.ts#L13)
