...
[label.ts:12](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/label.ts#L12)
...
• `Optional` **visuallyHidden**: `boolean`

Whether label should be visually hidden

#### Defined in

[label.ts:7](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/label.ts#L7)
