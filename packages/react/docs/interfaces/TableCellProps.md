...
• `Optional` **as**: [`TableCellElement`](../modules.md#tablecellelement)
...
[table.ts:36](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/table.ts#L36)
...
• `Optional` **colspan**: `Pick`<`HTMLProps`<`HTMLTableCellElement`\>, `"colSpan"`\>

#### Defined in

[table.ts:37](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/table.ts#L37)
...
• `Optional` **rowspan**: `Pick`<`HTMLProps`<`HTMLTableCellElement`\>, `"rowSpan"`\>

#### Defined in

[table.ts:38](https://github.com/aws-amplify/amplify-ui/blob/932629520/packages/react/src/primitives/types/table.ts#L38)
